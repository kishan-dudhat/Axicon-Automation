...
/**
 * Handle URL search param routing within the Blog Page
 */
...
function setupEventListeners() {
    // No need to listen for hash changes — navigation reloads the page with ?slug= param
...
function createBlogCard(post, index) {
    ...
    div.innerHTML = `
        ...
        <a href="/blog/blog-${post.id}.html" class="read-more-link">
            ...
            <div class="card-content">
                ...
                <h3 class="card-title">
                     <a href="/blog/blog-${post.id}.html">${post.title}</a>
                </h3>
